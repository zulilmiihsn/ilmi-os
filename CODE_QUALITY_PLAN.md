...
- [ ] Evaluasi lanjutan berbasis angka: CLS ~0 berarti bukan masalah — jangan kerjakan CLS. Transfer turun 75% tetapi LCP desktop tetap ~6.6s (dari FCP ~1.8s), jadi bottleneck bukan lagi byte gambar; kandidat berikutnya adalah identifikasi elemen LCP + font ~630KB (FA 271KB + SF 365KB) dan timing render/boot. Jangan klaim perbaikan tanpa ukur ulang; field data tetap dibutuhkan untuk kepastian.
